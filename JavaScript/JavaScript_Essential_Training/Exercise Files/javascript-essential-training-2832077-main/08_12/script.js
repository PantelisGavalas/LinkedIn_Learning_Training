...
if (everydayPack.volume >= 35 || everydayPack.pocketNum >= 10) {
  console.log("Backpack is very big.");
} else if (everydayPack.volume <= 10 || everydayPack.pocketNum <= 5) {
  console.log("Backpack is very small.");
}
